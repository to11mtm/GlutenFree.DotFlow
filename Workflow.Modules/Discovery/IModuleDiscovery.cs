...
public interface IModuleDiscovery
{
    ...
    /// </exception>
    IReadOnlyList<Type> DiscoverModuleTypes(Assembly assembly);
    ...
    /// </remarks>
    int DiscoverAndRegister(Assembly assembly, IModuleRegistry registry, IServiceProvider? services = null);
}
