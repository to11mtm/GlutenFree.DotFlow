...
public interface IModuleRegistry
{
    ...
    /// </exception>
    void RegisterModule(IWorkflowModule module, bool allowOverwrite = false);
    ...
    /// </exception>
    void RegisterModule(Type moduleType, IServiceProvider? services = null, bool allowOverwrite = false);
    ...
    IReadOnlyList<IWorkflowModule> GetModulesByCategory(string category);
    ...
    IReadOnlyList<IWorkflowModule> SearchModules(string query);
    ...
    /// </remarks>
    IDisposable Subscribe(IModuleRegistryObserver observer);
}
...
public interface IModuleRegistryObserver
{
    ...
    void OnModuleRegistered(IWorkflowModule module);
    ...
    void OnModuleUnregistered(string moduleId, IWorkflowModule module);
}
