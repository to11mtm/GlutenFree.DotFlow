...
/// <param name="ValidationRules">Immutable array of validation rules for this property. 🛡️</param>
/// <param name="DisplayMetadata">Immutable map of additional metadata for UI display (hints, grouping, etc.). 🎀</param>
/// <remarks>
