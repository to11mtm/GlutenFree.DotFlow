...
/// <param name="Properties">Configuration properties for this node instance (JSON elements). ⚙️</param>
...
/// <param name="Metadata">Additional metadata for extensibility. 💫</param>
/// <remarks>
