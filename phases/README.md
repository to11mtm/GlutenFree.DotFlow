...
- [Phase2-8-ModuleSystem.md](Phase2-8-ModuleSystem.md) ⏳ — module system enhancements: `.wfmod` package format, dependency resolution (topo sort + cycles), side-by-side versioning with pinning, pluggable module-state store (file default / repository optional), hot-reload with unload safety, optional signature verification, and the module upload/enable/disable/uninstall HTTP endpoints deferred from 2.7 (Q4). Builds on the existing 1.4.6 loader/ALC machinery. Weeks 21-22; Q1–Q7 resolved ✅~ 🌷
