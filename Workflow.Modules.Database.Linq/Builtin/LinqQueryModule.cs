    ...
    public ModuleSchema Schema => new(
        ...
        Properties: Arr.create(
            ...
            new ModulePropertyDefinition(
                ...
                "Query Code",
                typeof(string),
                "The linq method body (authored in Linq Studio; the compiled assembly is authoritative at runtime)~ 🧬",
                IsRequired: false,
                DefaultValue: null,
            ...
            new ModulePropertyDefinition(
                ...
                "Tables",
                typeof(List<string>),
                "Catalogued table names this query uses (resolved from the connection's table catalog)~ 📚",
                IsRequired: false,
                DefaultValue: null,
            ...
            new ModulePropertyDefinition(
                ...
                "Typed input definitions (name/type/required) used by Linq Studio authoring~ 🧬",
                IsRequired: false,
                DefaultValue: null,
                EditorType: PropertyEditorType.Json),
            new ModulePropertyDefinition(
